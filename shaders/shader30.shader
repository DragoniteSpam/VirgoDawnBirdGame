...
void main()
    {
    vec4 object_space_pos = vec4( in_Position.x+in_Colour.r*10.0*cos((uni_time)/1000.0 + in_Position.x),
                                  in_Position.y+in_Colour.r*10.0*sin((uni_time)/1000.0 + in_Position.x),
                                  in_Position.z, 1.0);
