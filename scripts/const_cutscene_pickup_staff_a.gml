...
ds_list_add(l, args(scr_do_if, scr_GetHasItem, Misc.equal, true, scr_goto, "end"));
...
ds_list_add(l, args(scr_do_if, scr_GetMultipleChoice, Misc.equal, 0, scr_move_to, NPCs.ItemStaffA, 0, 0, 0));
