/// create_translate_blob(x, y, z, direction, pitch, strength, caster);
...
mp_current=min(mp_current+get_attack_stat(id, CombatTypes.heal)+sqrt(argument5), get_max_mp(exp_mp));
